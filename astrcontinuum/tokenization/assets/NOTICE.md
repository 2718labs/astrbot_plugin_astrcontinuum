...
The encoding assets and the pinned encoding definitions originate from OpenAI's
`tiktoken` project. They are redistributed under the upstream MIT license in
`TIKTOKEN_LICENSE`.
